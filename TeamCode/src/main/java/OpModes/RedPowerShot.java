...
public class RedPowerShot extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (!isStopRequested()){
            ...
            drivetrain.moveGyro(-.8,29.8, 0);
            sleep(300);
            drivetrain.turnPD(4.2,.75,.65,2000);
            sleep(250);
            ...
            drivetrain.turnPD(-6.34,.75,.65,2000);
            sleep(500);
            shooter.flickPos();
            sleep(900);
            shooter.initPos();
            ...
            if (!secondWobbleGoal){
                if (targetZone == "A"){
                    ...
                    drivetrain.turnPD(180,.7,.4,4000);
                    sleep(300);
                    drivetrain.moveGyro(-.8, 30.3,180);
                    sleep(300);
                    drivetrain.turnPD(180,.8,.7,3000);
                }
                else{
